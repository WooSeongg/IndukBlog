                ...
                <div class="row gx-4 gx-lg-5 justify-content-center">
                    <div class="col-md-10 col-lg-8 col-xl-7">
                        <div class="page-heading">
                            <h1>${blog.title}</h1>
                            <span class="subheading">by ${blog.email}</span>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-md-10 col-lg-8 col-xl-7">
                        <div class="my-5">
                            ...
                            <form id="contactForm">
                                ...
                                <div class="form-floating">
                                    <span class="form-control" name="content" value="" id="message" placeholder="Enter your message here..." style="height: 12rem" data-sb-validations="required">
${blog.content}</span>
                                ...
                                <a href="updateForm.do?id=${blog.id}" class="btn btn-primary my-3">수정</a>
                                <a href="delete.do?id=${blog.id}" class="btn btn-danger">삭제</a>
<%--                                <%--%>
